...
class StreetNodes:
    ...
    def __init__(self, coords: list, connectedNodes: list, backNodes: list, nodeType: int, width=16, id=None):
        self.id = GMfun.generateRandomString(8, True, True, True) if id == None else id
        self.coords = coords
